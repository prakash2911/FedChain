...
def split_and_save_balanced_datasets(path, num_splits, random_state=None,test_size =0.2):
    ...
    for i, (train_data, train_labels) in enumerate(balanced_splits):
...
def split_dataset_stratified(X, y, num_splits, random_state=None):
    ...
    sss = StratifiedShuffleSplit(n_splits=num_splits, test_size=None, random_state=random_state)
    ...
    for train_index,_ in sss.split(X, y):
        ...
        splits.append((train_data, train_labels))
